...
Step 2: Deploying Flask to gcloud platform
       ...
       2. Copy the LSTM project url from gcloud and paste it in app.js file line 192 where it is written "your_lstm_gcloud_url/"
       (NOTE: DO NOT REMOVE "/")   
...
Step 3: To run locally:
       ...
       2. Go to cmd terminal and type following:
        ...
        b. source env\Scripts\activate.bat
